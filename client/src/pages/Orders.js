...
export default function Orders() {
  ...
  const filteredDetails = selectedPoRef
    ? data[selectedPoRef].filter((row) => {
        const dueDateMatch = !selectedDueDate || row['Due Date'] === selectedDueDate;
        const promisedDateMatch = !selectedPromisedDate || row['Promised Date'] === selectedPromisedDate;
        return dueDateMatch && promisedDateMatch;
      })
    : [];
    ...
    <div className="body-wrapper">
      ...
      <div className="container-fluid">
        ...
        <div className="form-group mt-3 col-md-4">
          <label htmlFor="poRefDropdown" className="select text-danger mb-3">Select PO Ref:</label>
          <select
            id="poRefDropdown"
        ...
        <div className="form-group mt-3 col-md-4">
          <label htmlFor="dueDateDropdown" className="select text-danger mb-3">Select Due Date:</label>
          <input
            type="date"
            id="dueDateDropdown"
            className="form-control"
        ...
        <div className="form-group mt-3 col-md-4">
          <label htmlFor="promisedDateDropdown" className="select text-danger mb-3">Select Promised Date:</label>
          <input
            type="date"
